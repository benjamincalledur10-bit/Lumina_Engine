...
final class LuminaControlCenterScreen {
    ...
    private static Screen create(
        ...
        LuminaShaderPresetGuide.forProfile(profile.pendingValue()).ifPresent(guide -> diagnostics
            .option(LabelOption.create(Component.translatable("lumina_engine.shader.event_horizon_preset", guide.eventHorizonPreset())))
            .option(LabelOption.create(Component.translatable("lumina_engine.shader.lite_preset", guide.luminaLitePreset())))
            .option(LabelOption.create(Component.translatable("lumina_engine.shader.guidance.manual"))));
        diagnostics
            .option(ButtonOption.createBuilder()
